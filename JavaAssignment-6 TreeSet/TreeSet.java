...
public class TreeSet {
	...
	public static void main(String[] args) {
		Employee emp1 = new Employee(1, "AmithKumar", "A", 20000L);
		 Employee emp2 = new Employee(3, "AjithKumar", "B", 25000L);
		 Employee emp3 = new Employee(2, "Anjali", "C", 30000L);
		 Employee emp4 = new Employee(4, "CharanKumar", "D", 35000L);
		 ...
		 String ch = sc.nextLine();
			...
			Set<Employee> set = new java.util.TreeSet<Employee>(new CustomSort(ch));
